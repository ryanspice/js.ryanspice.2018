...
export default new Array([
  ...
  <li>Italy</li>
...

	{
		...
		style:``,
		innerHTML:`
			<column id="contentMiddle" class="col-md-4 hidden-sm hidden-xs pull-right">
			...
			<column class='col-md-20'>

				<h2 style="">spice.js editor <span class="hidden-xs">0.0.2</span></h2>
			...
			<column class='col-md-4 pull-right hidden'>
				<br/>
